...
1. **Storage Integrity Diagnostics**: In this section, we can see the total amount of images and labels read and processed. One can also check if all images contain labels. This dataset have 137 samples without annotations. <br>
![Storage Intergrity Diagnostics](../assets/Dashboard_4.png)
3. **Class wise distribution of train and validation(val) sets**: This provides a clear spread of considered 10/12 classes over train and val set. This helps to identify class imbalance.<br>
![Class wise and Image Gallery](../assets/Dashboard_2.png)
5. **Weather wise distribution of train and val sets**: This helps to identify the spread of data over different climatic conditions like cloudy, snow, foggy or different timings of event like daytime, night. 
6. **Scene wise distribution of train and val sets**: This helps in understanding the distribution of data across various scenes like city street, gas station, highway, parking lot, etc,.<br>
![Weather and scene](../assets/Dashboard_1.png)
8. **Detailed anomalies identification within dataset based on below categories**   
...
![Anamolies](../assets/Dashboard_3.png)
9. **Image gallery**: To visualize sample images on the fly as we filter id provided in this dashboard. Also one can visualize BBOX drawn over filtered samples when playing around with anomalies. <br>
![Anamolies-extreme aspect ratio of CAR class shown in blue BBOX](../assets/Dashboard_5.png)
## Section 2: EVAL tab
...
This enables quantitative and qualitative analysis over results. <br>
![Eval metrics](../assets/Dashboard_6.png) <br>
![Eval metrics](../assets/Dashboard_7.png) <br>
